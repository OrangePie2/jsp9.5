...
if (uid != null) {
	if ((uid!= null) && (upass!= null) && (uname!= null) && (unumber!= null)) {
		RequestDispatcher ds = request.getRequestDispatcher("joinselect.jsp");
...
<body>
	<form method="post" name="frm" action="join.jsp">
		<table align="center" border="1">
			<tr>
				<td align="center" colspan="2">사원등록</td>
			</tr>
			...
			<tr>
				<td align="center" colspan="2"><input type="submit" value="등록"
					...
					value="취소"> <input type="submit" value="메인페이지로 이동"
